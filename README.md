...
VLESS Reality、VLESS TCP、VLESS WS、VLESS HTTPUpgrade、VLESS XHTTP、VLESS gRPC、VLESS TCP TLS、VLESS WS TLS、VLESS gRPC TLS、Trojan TCP、Trojan WS、Trojan HTTPUpgrade、Trojan XHTTP、Trojan gRPC、Trojan TLS、Trojan WS TLS、Trojan gRPC TLS、VMess TCP、VMess WS、VMess HTTPUpgrade、VMess XHTTP、VMess gRPC、VMess TCP TLS、VMess WS TLS、VMess gRPC TLS 使用 TCP。NAT 面板必须把外部端口的 `TCP` 转发到本机端口。
